...
Workflow Overview
User submits a Content Brief in Notion
n8n triggers the automation pipeline
AI generates:
Blog content
Social media captions
Newsletter draft
Visual prompt
Picsart generates an image using the visual prompt
Data is stored back in Notion
Review workflow is triggered automatically
